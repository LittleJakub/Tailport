...
REM
REM  Chain: app -> 127.0.0.1:<llm_port> -> forwarder -> SOCKS5
REM          -> WSL2 tailscaled -> ANY tailnet service
REM          (LLM on llm_target, plus every forward.N from config)
REM
...
echo [OK] Forwarder is listening on 127.0.0.1:%TP_LLM_PORT%
